...
Файл `.architecture.json` в директории `docs/arch/` проекта (или объект в вызове инструмента).
...
*(если `.architecture.json` лежит в `docs/arch/` — правила читаются автоматически без передачи `docs`)*
